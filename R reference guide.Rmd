...
2. In the `Environment` tab, click on `Import Dataset -> From CSV`.
...
7. Click on the line of code that says `read_csv` - this is the code that was generated to import the data set.  It should turn blue when you click on it.

8. Place your cursor in the R chunk that states _"Include code here to import the data"_.

9. In the upper right hand corner of RStudio, under the `History` tab, click on `To Source`.

10. Verify that the import code is now in your R chunk.
...
`plot(x = dataset$x_var, y = dataset$y_var, main = "Plot Title", xlab = "x axis label", ylab = "y axis label")` creates a scatterplot with a title and axis labels

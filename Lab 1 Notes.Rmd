...
# DataCamp Course Outline: Lab 1
- Use multiple choice questions on big picture programming topics.
   * what R is and what it is used for
   * uses of functions (built-in R) and why they exist
   * what a vector is and difference between vector and data frame --> vector is a variable in dataframe

- How to use DataCamp
- Using R as a calculator to perform arithetic
- Basic types of R data (numeric, integer, logical, character)
- Variable Assignment (using c() function to vector assignment)
- How to generate numbers using seq()
- Examining summary statistics from dataset or specific variables in dataset (access variable with $)
- Explore base R graphics with given dataset

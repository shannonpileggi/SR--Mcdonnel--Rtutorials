...
# Additional Notes
- For DataCamp course, practice using variables within data frame with dataframe$variable
- Also focus on how to change arguements in the plot() function to improve the graphs

# DataCamp Course Outline: Lab 2
- Built in R Functions that are used to explore datasets (names(), dim(), ect.)
- Access variables and run calculations on them
    * mean(), median(), sum()
- Create new variables in data frame
- Change or manipulate variables to make new ones
- Graph attributes like axis names and legend
